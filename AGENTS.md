...
Routes: `/` (home feed), `/search` (search + filters), `/movie/:id` (detail — overview, cast, media tabs), `/favorites` (favorited movies), `/popular` (this week's popular movies, with rank badges).
