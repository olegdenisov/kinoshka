...
// композицию Providers (initAnalytics()/reportWebVitals() вызваны при импорте модуля,
// RouterProvider обёрнут в GlobalErrorBoundary), не бизнес-логику router.tsx/
// GlobalErrorBoundary.tsx/analytics (у них свои тесты). initSentry() больше не импортируется из
// providers.tsx (переехал в sentry-bootstrap.ts, см. sentry-bootstrap.test.ts/main.test.ts).
